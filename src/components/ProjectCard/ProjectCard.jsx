...
export const ProjectCard = ({ project }) => {
  const handlenewTab = (project,linkname) => {
    if(linkname==="github")window.open(project.githunLink, "_blank");
    if(linkname==="live")window.open(project.liveLink, "_blank");
  };
    ...
    <section className="projectCard-container">
      <div className="image-conatiner">
        ...
        <div className="links-connect">
          <img onClick={()=>handlenewTab(project,"github")}
          ...
          {project.liveLink === "" ? (
            ...
            <img onClick={()=>handlenewTab(project,"live")}
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbHkAdVldqjLA8ucCXEthF31OyrleTqJtrUQ&s"
              alt="live demo"
            />
          )}
        </div>
