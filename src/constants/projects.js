...
export const projects = [
  {
    ...
    projectDescription:
      " Anime Sense is an anime-themed e-commerce application built using Spring Boot for the backend and React for the frontend.Customers can search for products with real-time filtering, manage their cart by adjusting quantities or removing items, and securely complete purchases using the Razorpay payment gateway.",
    tags: [
      { name: "react", color: "#00ffff" },
      { name: "springboot", color: "#82f06f" },
  ...
  },
  {
    projectName: "Garuda",
    projectDescription:
      "The Garuda Application is a full-stack flight booking system developed using React for the front end and Spring Boot for the backend, with Redux for state management and React Router DOM for navigation. The application allows users to search for flights, filter by airline names, and book flights efficiently.",
    tags: [
      { name: "react", color: "#00ffff" },
      { name: "springboot", color: "#82f06f" },
      { name: "mysql", color: "#78aae7" },
